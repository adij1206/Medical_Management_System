...
ResultSet rs = null;
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(45, 45, 45)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(addTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 283, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        if(addTxt.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Please enter the Product category" );
        }
        else{
            try{
                String sql = "INSERT INTO product_category(category) VALUES (?)";
                pst = conn.prepareStatement(sql);
                pst.setString(1, addTxt.getText());
                pst.execute();
